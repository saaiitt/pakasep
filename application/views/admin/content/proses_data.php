                            ...
                            <?php else : ?>
                                ...
                                foreach ($data->result() as $item) : ?>
                                    <tr>
                                        ...
                                        <td><?= $item->telp; ?></td>
                                        <td>
                                            <a href="<?= site_url('proses-data/edit/' . $item->id) ?>" class="btn btn-sm btn-success m-1">Edit</a>
                                            <a href="<?= site_url('proses-data/delete/' . $item->id) ?>" class="btn btn-sm btn-danger m-1">Delete</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
