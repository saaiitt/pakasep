            ...
            <div class="card-body">
                <div class="d-sm-flex d-block align-items-center justify-content-between mb-9 alert alert-success">
                    <div class="mb-3 mb-sm-0">
                        <h5 class="card-title fw-semibold">Data kerusakan Add</h5>
                    </div>
                </div>
                <form action="<?= site_url('data-kerusakan/insert'); ?>" method="post">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Kode kerusakan</label>
                                <input type="text" class="form-control" name="kode_kerusakan" id="exampleInputEmail1" aria-describedby="emailHelp" />
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nama_kerusakan" id="exampleInputEmail1" aria-describedby="emailHelp" />
                                <div id="emailHelp" class="form-text text-danger">
